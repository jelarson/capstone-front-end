    ...
    <div className='page-wrapper-quiz'>
      ...
      <div className='content-wrapper'>
        ...
        <div className='answer-submit-button-wrapper'>
          <Link to={{pathname: path, state: {selectedAnswer: selectedAnswer, selectedAnswerUrl: selectedAnswerUrl, currentQuestion: currentQuestion, quiz: 'Braille Quiz One', quizpath: 'brailleq1'}}} className='answer-submit-button'>Submit Answer</Link>
        </div>
      </div>
    </div>
  )
