...
export default function BrailleMastery(props) {
  ...
  useEffect(() => {
    axios
      .get("https://jel-user-capstone-api.herokuapp.com/user/17")
      .then((response) => {
      ...
      <div className='mastery-page-content-wrapper'>
        ...
        <div className='profile-bar'>
          ...
          <div className='progress-bar-content-wrapper'>
            <div className='progress-bar-wrapper'>
              <div className='progress-bar'>progress bar place holder</div>
              <div className='percent-score'>ph%</div>
            </div>
            <div className='overall-score'>
              {Number(user.testOneHighScore) +
                Number(user.testTwoHighScore) +
                Number(user.testThreeHighScore)}
              /51
            </div>
          </div>
        </div>
        <div className='test-wrapper'>
          <div className='test-one test'>
            test 1 placeholder
            <Link exact to='/braille' className='test-one-link link'>
              Begin Test
            </Link>
          </div>
          <div className='test-two test'>
            test 2 placeholder
            <Link exact to='/braille' className='test-two-link link'>
              Begin Test
            </Link>
          </div>
          <div className='test-three test'>
            test 3 placeholder
            {loggedInUser.name}
            <Link exact to='/braille' className='test-three-link link'>
              Begin Test
            </Link>
          </div>
        </div>
